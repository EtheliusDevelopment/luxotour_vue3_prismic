  ...
  <div class="question-box">
    <div class="inner-question-box">
      <h4 class="text-center text-primary question">
        How Many Peopled You Usually Travel With?
      </h4>
  ...
  <div class="quiz-layout">
    ...
    <div class="wrapper" :class="wrapper1">
      <q-img
        ...
        src="~assets/17-alone-travel.jpg"
    ...
    <div class="wrapper" :class="wrapper2">
      <q-img
        class="wrapped-section wrapped-section-one"
        src="~assets/18-significant-other.jpg"
        spinner-color="primary"
        spinner-size="82px"
        height="75%"
      >
    ...
    <div class="wrapper" :class="wrapper3">
      <q-img
        class="wrapped-section wrapped-section-one"
        src="~assets/19-family-travel.jpg"
        spinner-color="primary"
        spinner-size="82px"
        height="75%"
      >
    ...
    <div class="wrapper" :class="wrapper4">
      <q-img
        class="wrapped-section wrapped-section-one"
        src="~assets/20-friends-travel.jpg"
        spinner-color="primary"
        spinner-size="82px"
        height="75%"
      >
...
export default {
  ...
  methods: {
    ...mapActions(["quiz/actStep5"]),
    ...mapMutations({
      updateStep1: "quiz/updateStep5",
    }),
  },
